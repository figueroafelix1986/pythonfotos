...
from .common import *
from controllers.Ccuenta_subcuenta import CuentaSubCuenta, ControllerCuentaSubCuentas
...
class NuevaCuenta:
    def __init__(self, root):
        ...
        self.nueva_ventana.title("Agregar movimientos")
        self.padx = 10
        self.pady = 5
        self.controler = ControllerCuentaSubCuentas()
